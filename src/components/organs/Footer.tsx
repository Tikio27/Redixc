...
const Footer = () => {
    ...
    //     switch (element) {
    //         case 0:
    //             return <MapPinIcon size={20} color="currentColor" />;
    //         case 1:
    //             return <EnvelopeSimpleIcon size={20} color="currentColor" />;
    //         case 2:
    //             return <PhoneIcon size={20} color="currentColor" />
    //     }
    // }, [])

    return (
        <footer className="w-full bg-zinc-950 flex flex-col">
            <main className="w-full lg:pt-28 lg:pb-12 pt-20 pb-12 px-6 grid md:grid-cols-1 lg:gap-8 md:gap-5 gap-8 lg:px-32">
                <div className="flex flex-col gap-2">
                    <Link to={`/`} className="font-extrabold flex items-center relative md:text-3xl text-2xl">
                        ...
                        {/* <Text as="span" className="text-white">RED</Text>
                        <Text as="span" className="bg-gradient-to-r from-amber-500 to-red-500 bg-clip-text text-transparent">IXC</Text> */}
